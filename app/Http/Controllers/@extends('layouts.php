    ...
    <main>
        <div class="container">
            <div class="row">
                ...
                @endif
                <form method="post" action="{{ route('users.store') }}" id="userform" onsubmit="loaderscreen()"
                        ...
                        <div class="row py-3" id="functionality">
                            ...
                            <div class="text-end submit-btn">
                                ...
                                <input type="hidden" class="mx-4  btn btn-lg btn-primary" id="add_user"
                                    ...
                                    value="Submit">
                                <input type="button" class="mx-4  btn btn-lg btn-primary" name="add_user"
                                    onclick="validate()" value="Update">
                            </div>
                        </div>
