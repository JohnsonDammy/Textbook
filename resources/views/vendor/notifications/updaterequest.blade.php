                    ...
                    <tr>
                        <td align="center" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: sans-serif; ">
                            <h2 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">
                                 Collection Request Updated {{ $data['ref_number'] }}</h2>
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td align="center" bgcolor="#cfefcf">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: sans-serif; font-size: 16px; line-height: 24px;">
                            Please note that {{ $data['school_name'] }} - EMIS Number {{ $data['emis'] }} has updated the
                            collection request.</td>
                    </tr>
                    <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: sans-serif; font-size: 16px; line-height: 24px;">
                            <p style="margin: 0;">The information has been updated as follows:</p>
                        </td>
                    </tr>
                    <!-- end copy -->
                        ...
                        <td align="left" bgcolor="#ffffff">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    ...
                                    <th align="center">Old School<br/>Collection Count</th>
                                    <th align="center">New School<br/>Collection Count</th>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td align="center">{{ $item->old_count }}</td>
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: sans-serif; font-size: 16px; line-height: 24px;">
                            <p style="margin: 0;">Please click the link below to view the updated request</p>
