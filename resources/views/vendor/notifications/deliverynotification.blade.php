                    ...
                    <tr>
                        <td align="center" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: sans-serif; ">
                            <h2 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">
                                Delivery Notification - {{ $data->school->ref_number }}</h2>
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td align="center" bgcolor="#cfefcf">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: sans-serif; font-size: 16px; line-height: 24px;">
                            Please note the collection request for reference number {{ $data->school->ref_number }} have been repaired/ replenished
                            and are ready for delivery.</td>
                    </tr>
                    <!-- end button -->
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: sans-serif; font-size: 16px; line-height: 24px;">
                            <p style="margin: 0;">List of repaired/ replenished items:</p>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" bgcolor="#ffffff">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <th align="center">Items
                                        Description</th>
                                    <th align="center">Qty Collected</th>
                                    <th align="center">Qty
                                        Repaired</th>
                                    <th align="center">Qty Replenished</th>
                                </tr>
                                @foreach ($data->items as $item)
                                <tr>
                                    <td align="center">{{ $item->getCategoryDetails->name }} - {{ $item->getItemDetails->name }}</td>
                                    <td align="center">{{ $item->confirmed_count }}</td>
                                    <td align="center">{{ $item->repaired_count }}</td>
                                    <td align="center">{{ $item->approved_replenished_count }}</td>
                                </tr>
                                @endforeach
