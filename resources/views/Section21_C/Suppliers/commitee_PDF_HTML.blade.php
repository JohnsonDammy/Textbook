...
<body>
    ...
    <div class="container">
        <div class="label-container">
            <div class="kop">Name of School: {{ strtoupper($schoolname) }}</div>
            <div class="kop1">EMIS No: {{ substr($emis, 3) }}</div>
        </div>
        <br><br>
 
        <div class="label-container">
            <div class="kop">District: {{ strtoupper($districtName) }}</div>
            <div class="kop1">Circuit: {{ strtoupper($circuitName) }}</div>
        </div>
        <br><br><br>
        ...
        <div class="label-container">
            <div class="kop">
                <table border="1">
                    ...
                    <tr><th>Name</th> <th>*** Designation </th> <th>Contact No.</th> <th>Email</th> <th>Signature</th><th>Date</th></tr>
