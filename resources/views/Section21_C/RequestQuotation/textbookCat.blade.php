            ...
            <div class="tabs">
                @if (session('quoteStatus') == "Allocated Funds" )
                    <a href="#" class="tab-link {{ session('activeTab') == 'tab1' ? 'active' : '' }}" data-tab="tab1"
                        data-toggle="1">Textbook Catalogue</a>
                @endif
                            ...
                            <div class="row justify-content-center align-items-center g-4">
                                ...
                                <div class="col-12 col-md-6 col-xl-3">
                                    <select class="form-select form-control rounded-0" id="C" name="Grade"
                                        ...
                                        @if ($schoolLevel == 3)
                                            <option value="1" {{ session('selectedGrade') == '1' ? 'selected' : '' }}>1
                                            </option>
                                            <option value="2" {{ session('selectedGrade') == '2' ? 'selected' : '' }}>2
                                            </option>
                                            <option value="3" {{ session('selectedGrade') == '3' ? 'selected' : '' }}>
                                                3
                                            </option>
                                            <option value="4" {{ session('selectedGrade') == '4' ? 'selected' : '' }}>
                                                4
                                            </option>
                                            <option value="5" {{ session('selectedGrade') == '5' ? 'selected' : '' }}>
                                                5
                                            </option>
                                            <option value="6" {{ session('selectedGrade') == '6' ? 'selected' : '' }}>
                                                6
                                            </option>
                                            <option value="7" {{ session('selectedGrade') == '7' ? 'selected' : '' }}>
                                                7
                                            </option>

                                            <option value="8" {{ session('selectedGrade') == '8' ? 'selected' : '' }}>
                                                8
                                            </option>
                                            <option value="9" {{ session('selectedGrade') == '9' ? 'selected' : '' }}>
                                                9
                                            </option>
                                            <option value="10"
                                        ...
                                        @elseif ($schoolLevel == 1)
                                            <option value="1" {{ session('selectedGrade') == '1' ? 'selected' : '' }}>
                                                1
                                            </option>
                                            <option value="2" {{ session('selectedGrade') == '2' ? 'selected' : '' }}>
                                                2
                                            </option>
                                            <option value="3" {{ session('selectedGrade') == '3' ? 'selected' : '' }}>
                                                3
                                    ...
                                    <div class="row justify-content-center align-items-center g-4"
                                        ...
                                        <div class="col-6 col-md-6 col-xl-2">
                                            <input type="submit" id="submitFormButton" class="btn btn-primary btn-sm"
                                                value="Save & Continue" @if (session('quoteStatus') != "Allocated Funds") disabled @endif>
                        ...
                        <div class="row justify-content-center align-items-center g-4">
                            ...
                            <div class="scrollable-table">
                                @php
                                    $TotalAccumalated = 0;
                                @endphp
                                <center><label id="OrderValue" style="color:red; display:none;"> Order amount is greater than allocation funds, please adjust your quantity value</label></center><br>
                                <table class="table">
                                    <thead>
                                        <tr>
                                                ...
                                                <tr>
                                                   ...
                                                   @php
                                                       if( $TotalAccumalated > session('AllocatedAmt')){
                                                        echo "<script>document.getElementById('OrderValue').style.display='block';</script>";
                                                       }else{
                                                        echo "<script>document.getElementById('OrderValue').style.display='none';</script>";
                                                       }
                                                   @endphp
                                            ...
                                            <tbody>
                                                <tr class="pt-1 px-1">
                                                 @if (session('quoteStatus') ==  'Allocated Funds')
                                                  ...
                                                  @endif
                                                    <td class="col-md">
                                                        <a href="{{ route('viewQuotess') }}" target="_blank"
                                                 ...
                                                 @endif
                                                    ...
                                                    <td class="col-md" style="color: {{ $TotalAccumalated > session('AllocatedAmt') ? 'red' : 'green' }}">
