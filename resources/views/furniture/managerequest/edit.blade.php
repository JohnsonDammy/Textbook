...
<script>
    ...
    var collection_id = <?php echo json_encode($data->id); ?>;
    var db_count = <?php echo json_encode($data->total_furniture); ?>;
    broken_item_array = window.localStorage.getItem(`editBrokenItems${collection_id}`) ? JSON.parse(window.localStorage.getItem(
        `editBrokenItems${collection_id}`)) : <?php echo json_encode($items); ?>;
    totalcount = window.localStorage.getItem(`editTotalCount${collection_id}`) ? window.localStorage.getItem(
        `editTotalCount${collection_id}`) : db_count;
    console.log(totalcount);
    csrf_token = "{{ csrf_token() }}"
</script>

@section('title', 'Manage Request Edit')
@section('content')
<main>
    <div class="container">
        <!-- breadcrumb -->
            ...
            <div class="col-12 col-md-12 col-xl-12">
                <div class="page-titles">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('manage-requests.index') }}">Manage Request</a>
                        </li>
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Update Request</a>
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12 col-md-12 my-3">
                    <div class="row g-4">
                        ...
                        <div class="form-group col-12 col-md-6 col-xl-4">
                            <input type="number" class="form-control form-control-lg" required="required" placeholder=" " id="total_furniture" value="{{ $data->total_furniture }}" min="0" oninput="this.value =
    ...
    <div class="modal-dialog modal-dialog-centered popup-alert">
        <div class="modal-content">
            <div class="modal-body">
                <div class="text-center">
                    <img src="{{ asset('img/popup-check.svg') }}" class="img-fluid mb-5" alt="">
                    <h4 class="popup-alert_title">Transaction - Manage Request</h4>
                    <p class="popup-alert_des">Your Collection Request for Reference Number <span id="ref_no_popup"></span> has been updated successfully!</p>
                </div>
        ...
        <div class="modal-content models__content">
            <div class="models__header">
                <div class="models__header_text">
                    <h5 class="modal-title">+ Report Damaged Item</h5>
                </div>
                            ...
                            <div class="form-group col-12 col-md-6 col-xl-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="text-muted furniture-items-counter fs-2">
                                        ...
                                        <span style="display: none;" class="text-danger fs-4" id="validcreatecounterr" role="alert">
    ...
    <div class="modal-dialog modal-dialog-centered popup-alert">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-around text-center">
                ...
                <a href="{{ route('manage-requests.index') }}"><button type="button" class="btn btn-secondary px-5">Yes</button></a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered popup-alert">
        <div class="modal-content">
            <div class="modal-body">
                <div class="text-center">
                    <img src="{{ asset('img/confirmation-popup.svg') }}" class="img-fluid mb-5" alt="">
                    <h4 class="modal-title popup-alert_des fw-bold">Transaction - Manage Request</h4>
...
@endsection
@section('foot-script')
<script src="{{ asset('js/editRequest.js') }}"></script>
@endsection