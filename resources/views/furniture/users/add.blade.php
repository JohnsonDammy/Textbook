                    ...
                    <div class="col-12 col-md-4">
                        <div class="page-titles">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item acti++ve"><a href="javascript:void(0)">Add User</a></li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-xl-12">
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-xl-6">
                                ...
                                @endif
                                <label for="user-type-select">Select Roles<span class="text-danger">*</span></label>
                            </div>
                            <!-- <br> -->
