            ...
            <div class="col-12 mb-4">
                <div class="row g-4 align-items-center">
                    ...
                    <div class="row g-4 align-items-center" id="Replenishmentform" style="display: none;">
                        ...
                        <form method="post" action="/furniture-replacement/collect/disposalimages" enctype="multipart/form-data" id="uploadDisposalImages">
                            @csrf
                        ...
                        if ($('#uploadDisposalImages').submit()) {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    link.href = window.URL.createObjectURL(blob);
                                    link.download =
                                        `${ref_number} - Replenishment Request Form.pdf`;
                                    link.click();
                                    $('#preloader').css('display', 'none');
