            ...
            <div class="col-12 col-md-4">
                <div class="page-titles">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Update Circuit</a>
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="row mb-5">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="text-center">
                                ...
                                <h4 class="popup-alert_title">School Maintenance - Update Circuit</h4>
            ...
            <div class="col-12 col-md-12">
                <div class="row g-5 align-items-center">
                    <form class="" method="post" action="{{route('schoolcircuit.update', $circuit->id)}}" data-parsley-validate>
                        <input type="hidden" name="_method" value="PATCH">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="col-12 col-md-6 col-xl-6">
                            <div class="form-group ">
                                <input type="text" class="form-control form-control-lg" name="circuit_name" id="circuit_name" value="{{ old('circuit_name' , $circuit->circuit_name) }}" required data-parsley-pattern="/^[a-z\d\-'_\s]+$/i" data-parsley-pattern-message="Circuit accept alphabets and numbers" data-parsley-required-message="Circuit is required" placeholder=" ">
                        ...
                        <div class="col-12 col-md-6 col-xl-6">
                            <div class="form-group ">
                                <select class="form-select form-control form-control-lg" name="cmc_id" id="cmc_id" required data-parsley-required-message="CMC is required">
                                    ...
                                    <option value="{{ $cmc->id }}" {{ old('cmc_id', $circuit->cmc_id  ) == $cmc->id ? 'selected="selected"' : '' }}>{{ ucwords($cmc->cmc_name) }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="text-end submit-btn my-4">
                            ...
                            <input type="submit" class="mx-4  btn btn-lg btn-primary" id="update_circuit" name="update_circuit" data-bs-toggle="modal" data-bs-target="#alret-pop" value="Update">
                        </div>
                    </form>
                </div>
            </div>
