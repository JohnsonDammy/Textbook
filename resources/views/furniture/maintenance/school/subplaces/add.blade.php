...
@section('title', 'Add School Sub Place')
@section('content')
<!-- main -->
<main>
    <div class="container">
            ...
            <div class="col-12 col-md-4">
                <div class="page-titles">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Add New Sub Place</a>
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="row mb-5">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="text-center">
                                ...
                                <h4 class="popup-alert_title">School Maintenance - Add Sub Place</h4>
            ...
            <div class="col-12 col-md-12">
                <div class="row g-5 align-items-center">
                    <form class="" method="post" action="{{route('schoolsubplace.store')}}" data-parsley-validate>
                        @csrf()
                        <div class="col-12 col-md-6 col-xl-6">
                            <div class="form-group ">
                                <input type="text" class="form-control form-control-lg" name="subplace_name" id="subplace_name" value="{{ old('subplace_name') }}" required data-parsley-pattern="/^[a-z\d\'-_\s]+$/i" data-parsley-pattern-message="Sub place accept alphabets and numbers" data-parsley-required-message="Sub place is required" placeholder=" ">
                        ...
                        <div class="col-12 col-md-6 col-xl-6">
                            <div class="form-group ">
                                <select class="form-select form-control form-control-lg" name="circuit_id" id="circuit_id" required data-parsley-required-message="Circuit is required">
                                    ...
                                    <option value="{{ $circuit->id }}" {{ old('circuit_id') == $circuit->id ? 'selected="selected"' : '' }}>{{ ucwords($circuit->circuit_name) }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="text-end submit-btn my-4">
                            ...
                            <input type="submit" class="mx-4  btn btn-lg btn-primary" id="add_subplace" name="add_subplace" data-bs-toggle="modal" data-bs-target="#alret-pop" value="Add">
                        </div>
                    </form>
                </div>
            </div>
