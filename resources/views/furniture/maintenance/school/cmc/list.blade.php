            ...
            <div class="col-12 col-md-4">
                <div class="page-titles">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">CMC</a></li>
                    </ol>
                </div>
            </div>
            <div class="offset-xl-3 col-12 col-md-4 col-xl-2 mb-3">
                <a href="{{ route('schoolcmc.create') }}" class="btn btn-primary w-100">+ Add New CMC</a>
            </div>
            <div class="col-12 col-md-4 col-xl-3 mb-3">
                <div id="search-btn">
                    <form class="d-flex" method="GET" action="/schoolcmc-search">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="text-center">
                                ...
                                <h4 class="popup-alert_title">School Maintenance - School CMC</h4>
                    ...
                    <table class="table">
                        ...
                        @if(count($data) < 1) <tbody>
                            <tr class="text-center text-dark">
                                <td colspan="7">No CMCs Found</td>
                            </tr>
                            </tbody>
                            @else
                            @foreach ($data as $key => $cmc)
                            <tbody>
                                <tr>
                                    <td>{{ ucwords($cmc->cmc_name) }}</td>
                                    <td>{{ ucwords($cmc->getDistrictDetails->district_office) }}</td>
                                    <td>
                                        <div class="d-flex justify-content-end">
                                            @can('school-edit')
                                            <a href="{{ route('schoolcmc.edit',$cmc->id) }}" class="color-primary me-4 fs-2">
                                                <i class="ri-pencil-fill"></i>
                                            </a>
                                            @endcan
                                            @can('school-delete')
                                            <form action="{{  route('schoolcmc.destroy',$cmc->id) }}" method="POST">
                                                <input type="hidden" name="_method" value="DELETE">
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">

                                                <!-- Button trigger modal -->
                                                <button class="btn-reset" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal{{$cmc->id}}">
                                                    <i class="ri-delete-bin-7-fill"></i>
                                                </button>

                                                <div class="modal fade" id="exampleModal{{$cmc->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered popup-alert">
                                                        <div class="modal-content">
                                                            <div class="modal-body">
                                                                <div class="text-center">
