...
@section('title', 'Update School District')
@section('content')
<main>
    <div class="container">
            ...
            <div class="col-12 col-md-12">
                <div class="page-titles">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)"> Update School District</a></li>
        ...
        <div class="row mb-5">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="text-center">
                                ...
                                <h4 class="popup-alert_title">School Maintenance - Update School District</h4>
            ...
            <div class="col-12 col-md-12">
                <div class="row g-5 align-items-center">
                    <form class="" method="post" action="{{route('schooldistricts.update', $district->id)}}" data-parsley-validate>
                        <input type="hidden" name="_method" value="PATCH">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="col-12 col-md-6 col-xl-6">
                            <div class="mb-5">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="district_office" name="district_office" required data-parsley-pattern="/^[a-z\d\-'_\s]+$/i" data-parsley-pattern-message="District Name accept alphabets and numbers" data-parsley-required-message="District office is required" placeholder=" " value="{{ old('district_office' , $district->district_office) }}">
                                    @if($errors->has('district_office'))
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $errors->first('district_office') }}</strong>
                                    </span>
                                    @endif
                                    <label for="district_office">District<span class="text-danger">*</span></label>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-6 col-xl-6">
