...
<main>
    <div class="container">
            ...
            <div class="col-12 col-md-12">
                <div class="page-titles">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Update Item Category</a>
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="row mb-5">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="text-center">
                                ...
                                <h4 class="popup-alert_title">Catalogue Maintenance - Update Item Category</h4>
            ...
            @endif
            <form class="" method="post" action="{{route('stockcategories.update', $category->id)}}" data-parsley-validate>
                        ...
                        <div class="col-12 col-md-6 col-xl-3">
                            <div class="mb-5">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg wide rounded-0" id="furniture-category-1" name="name" value="{{ old('name' , $category->name) }}" required data-parsley-required-message="Category name is required" placeholder=" ">
                                    @if($errors->has('name'))
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $errors->first('name') }}</strong>
                                    </span>
                                    @endif
                                    <label for="furniture-category-1">Item Category Name<span class="text-danger">*</span></label>
                                </div>
                            </div>
                            <div class="text-end">
                                <button type="submit" id="update_category" name="update_category" class="btn btn-lg ">Update</button>
                            </div>
                        </div>
