            ...
            <div class="col-12 col-md-4">
                <div class="page-titles">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Item Description</a></li>
                    </ol>
                </div>
            </div>
            <div class="offset-xl-3 col-12 col-md-4 col-xl-2 mb-3">
                @can('item-create')
                <a href="{{ route('stockitems.create') }}" class="btn btn-primary w-100">+Add new Item Description</a>
                @endcan
            </div>
            <div class="col-12 col-md-4 col-xl-3 mb-3">
                <div id="search-btn">
                    <form class="d-flex" method="GET" action="/stockitems-search">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="text-center">
                                ...
                                <h4 class="popup-alert_title">Catalogue Maintenance - Item Description</h4>
                    ...
                    <table class="table">
                        ...
                        @if(count($data) < 1) <tbody>
                            <tr class="text-center text-dark">
                                <td colspan="2">No Item Description Found</td>
                            </tr>
                            </tbody>
                            @else
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex ">
                                            @can('item-edit')
                                            <a href="{{ route('stockitems.edit',$item->id) }}" class="color-primary me-4 fs-2">
                                                <i class="ri-pencil-fill"></i>
                                            </a>
                                            @endcan
                                            @can('item-delete')
                                            <form action="{{  route('stockitems.destroy',$item->id) }}" method="POST">
