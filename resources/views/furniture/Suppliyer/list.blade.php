                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <a href="{{ route('schoolsupplier.edit', ['id' => $supplier->Id]) }}" class="color-primary me-4 fs-2">
                                                <i class="ri-pencil-fill"></i>
                                            </a>
                                        @else
                                            <a href="{{ route('schoolsupplier.edit', ['id' => $supplier->Suppliyer_id]) }}" class="color-primary me-4 fs-2">
                                                <i class="ri-pencil-fill"></i>
                                            </a>
                                        @endif
                                            <form action="{{  route('schoolsupplier.destroy') }}" method="POST">
                                                ...
                                                <input type="hidden" name="DelVal" value="{{ $supplier->Id }}">

                                                <!-- Button trigger modal -->
                                                <button class="btn-reset" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal{{$supplier->Id}}">
