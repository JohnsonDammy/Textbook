                ...
                <div class="col-12 col-md-4">
                    <div class="page-titles">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Supplier List</a></li>
                        </ol>
                    </div>
                </div>
                <div class="offset-xl-3 col-12 col-md-4 col-xl-2 mb-3">
                    <a href="{{ route('Suppliyer.Add') }}" class="btn btn-primary w-100">+ Add New Supplier</a>
                </div>
                <div class="col-12 col-md-4 col-xl-3 mb-3">
                    <div id="search-btn">
                        <form class="d-flex" method="GET" action="{{ route('schoolsupplier.search') }}">
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th> Email</th>
                                    <th id="Doc1"> Download </th>
                                    <th id="Doc2"> Download </th>
                            ...
                            @else
                                @foreach ($data as $key => $supplier)
                                    <tbody>
                                        ...
                                        $supplierExist = $suppliersData
                                            ->where('supplierID', $supplier->Suppliyer_id)
                                            ->where('emis', $emis)
                                            ->first();
                                        
                                        $capturedSupplierRecord  = null;
                                        
                                        //Validate if supplier exists   , if it does , set the capturedSupplierRecord
                                       if ($supplierExist !== null)
                                       {
                                        $capturedSupplierRecord= $capturedSuppliers->where('savedSupplierID',   $supplierExist->id )->first();
                                       }
                                    ...
                                    @endphp
                                        ...
                                        <tr>
                                            ...
                                            @if ($capturedSupplierRecord === null)
                                            <script>
                                            ...
                                            <td id="Data1">
                                                <i class="fas fa-download"    @if ($capturedSupplierRecord != null) style="color: green ;" @else style="color:  grey;" @endif ></i>
                                                <a
                                                    @if ($capturedSupplierRecord != null)
                                                    href="{{ route('downloadQuoteSupplier', ['supplierID' =>$supplier->Suppliyer_id]) }}"
                                            ...
                                            @if ($capturedSupplierRecord != null)
                                            <td id="Data2">   <i class="fas fa-download"    @if ($capturedSupplierRecord != null) style="color: green ;" @else style="color:  grey;" @endif ></i>
                                                <a
                                                  @if ($capturedSupplierRecord != null) 
                                                    href="{{ route('downloadSBD4Supplier', ['supplierID' => $supplier->Suppliyer_id]) }} "
                                                    style="color:green; text-decoration: underline; font-style: italic;"
                                                  @endif >
                                                </a>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-end">
                                                    ...
                                                    @if (Auth::user()->username == 'Admin')
                                                        <a href="{{ route('schoolsupplier.edit', ['id' => $supplier->Id]) }}"
                                                            class="color-primary me-4 fs-2">
                                                            <i class="ri-pencil-fill"></i>
                                                        </a>
                                                    @else
                                                        <a href="{{ route('schoolsupplier.edit', ['id' => $supplier->Suppliyer_id]) }}"
                                                            class="color-primary me-4 fs-2">
                                                            <i class="ri-pencil-fill"></i>
                                                        </a>
                                                    @endif
                                                    <form action="{{ route('schoolsupplier.destroy') }}" method="POST">
                                                        @csrf()

                                                        <input type="hidden" name="DelVal"
                                                            value="{{ $supplier->Id }}">
                                                        ...
                                                        <div class="modal fade" id="exampleModal{{ $supplier->Id }}"
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-body">
                                                                        <div class="text-center">
                                                                            ...
                                                                            <h4
                                                                                class="modal-title popup-alert_des fw-bold">
                                                                                Delete</h4>
