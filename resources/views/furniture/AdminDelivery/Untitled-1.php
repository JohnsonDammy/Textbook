...
{{--     <div style="page-break-before: always;"></div> --}}
    ...
    <div class=WordSection1>
          ...
          <div style="page-break-before: always;"></div>
    <p>
        <img src="{{ asset('public/img/iconss.jpg') }}" width="141px" height="78px">
    </p>
    ...
    <table border="1" class="anotherB">
        ...
        <tr>
            <td colspan="9"><p class=MsoNormal><span style='font-size:12pt;line-height:106%'>Please furnish
        ...
        <tr>
            <td colspan="9"><p class=MsoNormal><span style='font-size:12pt;line-height:106%'>For
   ...
   @endif
    ...
    <table  border="1" class="anotherT table" >
     ...
     {{--    <tr>
        ...
        <tr>
            <td colspan="2"><label class="txt">PAGE TOTAL : {{  $totalChunks}} </label></td><td>&nbsp;</td><td>&nbsp;</td>
        </tr> --}}
        <tr>
    ...
    <table class="anotherK" border="1">
        ...
        <tr>
            <td  width="120px"><label class="txt"> QUOTATION FOR TEXTBOOKS </td></label><td>1</td width="50px"><td width="50px">2</td>
        </tr>
    </table>
    </div>
    </main>
