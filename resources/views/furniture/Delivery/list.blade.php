            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <input type="hidden" name="user" value="{{ Auth::user()->organization }}">
                                ...
                                @foreach ($data as $key => $supplier)
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{ $supplier->date }}</td>
                                            @if (Auth::user()->organization == 3)
                                                <td><button>Caputure Data</button></td>
                                            @else
                                                <td>
                                                    <div class="d-flex justify-content-end">
                                                        ...
                                                        @else
                                                            <a href="{{ route('Delivery.edit', ['id' => $supplier->Id]) }}"
                                                                class="color-primary me-4 fs-2">
                                                                <i class="ri-pencil-fill"></i>
                                                            </a>
                                                        @endif
                                                        <form action="{{ route('Delivery.destroy') }}" method="POST">
                                                            @csrf()
