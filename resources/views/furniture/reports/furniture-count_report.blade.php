...
@section('title', 'LTSM Count Report')
@section('content')
<!-- main -->
<main>
    <div class="container">
        ...
        <div class="row align-items-center border-bottom border-2">
            <div class="col-12 col-md-6 col-xl-4">
                <div class="page-titles">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">LTSM Count Report</a>
                        </li>
                    </ol>
                </div>
            </div>
            <div class="offset-xl-5 text-end col-12 col-md-6 col-xl-3 mb-3">
                ...
                <select class="form-control form-control-lg fs-4 wide rounded-0" id="furniture-category">
                        ...
                        <option value="/reports/furniture-count" selected>LTSM Count Report</option>
        ...
        <div class="row justify-content-center align-items-center">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="text-center">
                                ...
                                <h4 class="popup-alert_title">LTSM Count Report</h4>
            ...
            <div class="col-12 col-md-9 my-3">
                ...
                <form class="row  g-4" method="GET" action="/reports/furniture-count/search">
                    @if(Auth::user()->organization != 2)
                    <div class="col-12 col-md-6 col-xl-4">
                ...
                <table class="table table-nnowrap">
                    <thead>
                        <tr>
                            ...
                            <th>Collection Requested Count</th>
                            <th>Collection Confirmed Count</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{ $item['school_inventory_count'] }}</td>
                            <td>{{ $item['furniture_category'] }}</td>
                            <td>{{ $item['furniture_item'] }}</td>
                            <td>{{ $item['collection_requested_count'] }}</td>
                            <td>{{ $item['collection_confirmed_count'] }}</td>
...
<script>
    ...
    $('#download_report').on('click', function() {
        ...
        $.ajax({
            url: "/reports/furniture-count/download",
            type: "get",
            data: {
            ...
            success: function(response) {
                ...
                link.download = `LTSM Count Report.xls`;
                link.click();
                console.log('success')
            },
            error: function(err) {
