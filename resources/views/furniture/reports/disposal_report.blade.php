    ...
    <div class="container">
        ...
        <div class="row align-items-center border-bottom border-2">
            <div class="col-12 col-md-6 col-xl-4">
                <div class="page-titles">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Disposal Report</a>
                        </li>
                    </ol>
                </div>
            </div>
            <div class="offset-xl-5 text-end col-12 col-md-6 col-xl-3 mb-3">
                ...
                <select class="form-control form-control-lg fs-4 wide rounded-0" id="furniture-category">
                        ...
                        <option value="/reports/disposal" selected>Disposal Report</option>
        ...
        <div class="row justify-content-center align-items-center">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="text-center">
                                ...
                                <h4 class="popup-alert_title">Disposal Report</h4>
            ...
            <div class="col-12 col-md-9 my-3">
                <form class="row  g-4" action="/reports/disposal/search">
            ...
            <div class="col-12 col-md-3 my-3">
                ...
                <div class="col-12 mt-4 d-flex align-items-center justify-content-center">
                    <a href="/reports/disposal" class="px-4 fs-3 btn-reset text-decoration-underline">Reset</a>
                </div>
            </div>
            </form>
        </div>
    ...
    $('#download_report').on('click', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                link.download = `Disposal Report.xls`;
                link.click();
                console.log('success')
            },
            error: function(err) {
