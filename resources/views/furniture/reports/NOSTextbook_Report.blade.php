...
@section('title', 'School Choose Textbook Report')
@section('content')
<!-- main -->
<main>
    <div class="container">
            ...
            <div class="col-12 col-md-6 col-xl-4">
                <div class="page-titles">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Number of school that choose Textbook</a>
                        </li>
                    </ol>
                </div>
            </div>
            <div class="offset-xl-5 text-end col-12 col-md-6 col-xl-3 mb-3">
                ...
                <div class="form-group">
                    <select class="form-control form-control-lg fs-4 wide rounded-0" id="furniture-category">
                        ...
                        <option value="/reports/replenishment" selected>NOS - Textbook Report</option>
                        <option value="/reports/disposal">NOS - Stationery Report</option>
...
<script>
    document.getElementById('download_report').addEventListener('click', function () {
        ...
        exportToExcel('reportTable', 'NOSTextbook_Report');
    });
